  ...
  function renderRow(a) {
    ...
    return (
      <Fragment key={a.id}>
        ...
        <li className="hidden items-center gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-card dark:border-ink-border dark:bg-ink-card md:flex md:gap-4">
          ...
          {a.priority === 'Critical' && !done && (
            <span className="shrink-0 rounded-md bg-rose-50 px-2 py-1 text-[11px] font-bold text-rose-500 dark:bg-rose-500/10 dark:text-rose-400">
              Critical
            </span>
          )}
        ...
        {/* Mobile: stacked card */}
        <li className="rounded-2xl border border-slate-200 bg-white p-3.5 shadow-card dark:border-ink-border dark:bg-ink-card md:hidden">
