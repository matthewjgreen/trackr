...
export default function AvatarMenu({ size = 36 }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="animate-pop-in absolute right-0 z-50 mt-2 w-44 origin-top-right overflow-hidden rounded-xl border border-slate-200 bg-white py-1 shadow-soft dark:border-ink-border dark:bg-ink-card">
          <button
            onClick={() => {
              setOpen(false)
              navigate('/settings')
